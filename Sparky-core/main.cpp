...
int main()
{
	...
	shader.setUniformMat4("pr_matrix", maths::mat4::orthographic(-16.0f, 16.0f, -9.0, 9.0f, -1.0f, 1.0f));
	Timer time;
	float timer = 0;
...
/*		double x, y;
		...
		shader.setUniform2f("light_pos", vec2((float)(x * 32.0f / 960.0f - 16), (float)(9.0f - y * 18.0f / 540.0f)));
		//shader.setUniform2f("light_pos", vec2((float)(x * 32.0f / 960.0f - 16), (float)(9.0f - y * 18.0f / 540.0f)));
